...
const ahaEmailSchema = require(path.join(__dirname, '../schemas/AhaEmailMaster'));
const ahaLogSchema = require(path.join(__dirname, '../schemas/AhaLogMaster'));
const aurusEmailSchema = require(path.join(__dirname, '../schemas/AurusEmailMaster'));
const s3ImageData = require(path.join(__dirname, "./StaticModule"));
